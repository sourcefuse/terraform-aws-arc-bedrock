locals {
  ...
  knowledge_base_config = merge(var.knowledge_base_config, { agent_id = var.knowledge_base_config.agent_id == null ? aws_bedrockagent_agent.this[0].agent_id : var.knowledge_base_config.agent_id })
}
